...
<div id="aCoursesList" class="bg-fa of">
    ...
    <div>
        ...
        <section class="p-h-video-box" id="videoPlay">
            <img height="345px" width="630px" :src="courseWebVo.cover" :alt="courseWebVo.title" class="dis c-v-pic">
        </section>
        </article>
        ...
        <section class="ml20 mr15">
            ...
            <section class="c-attr-mt">
              <span v-if="isbuyCourse || Number(courseWebVo.price)===0">
                <a href="#" title="立即观看" class="comm-btn c-btn-3">立即观看</a>
              </span>
              <span v-else>
                <a href="#" @click="creatOrders()" title="立即购买" class="comm-btn c-btn-3">立即购买</a>
              </span>
    ...
    <div class="mt20 c-infor-box">
                ...
                <section class="mt20">
                    ...
                    <menu id="lh-menu" class="lh-menu mt10 mr10">
                        ...
                        <li class="lh-menu-stair" v-for="chapter in chapterList" :key="chapter.id">
                            ...
                            <li class="lh-menu-second ml30" v-for="video in chapter.videVoList" :key="video.id">
        ...
        <div class="i-box">
            ...
            <section class="stud-act-list">
                ...
                <li>
                    <div class="u-face">
                        <!-- <router-link :to="{path:'/course/_id',query:{ id:courseWebVo.id }}" class="around">
...
//                 chapterList: response.data.data.allChapterVideoByCourseId
//             }
//         })
//     }
// };
  ...
  methods: {
    ...
    getCourseInfo() {
      courseApi.getCourseInfo(this.courseId).then((response) => {
        this.chapterList = response.data.data.allChapterVideoByCourseId;
        this.courseWebVo = response.data.data.courseWebVo;
        this.courseWebVo.courseId = response.data.data.courseWebVo.id;
        console.log("是否已经购买："+response.data.data.isBuyCourse);
        this.isbuyCourse = response.data.data.isBuyCourse
      });
    },
    initComment() {
        commonApi.getPageList(this.page, this.limit, this.courseId)
        .then((response) => {
    ...
    addComment() {
      ...
      commonApi.addComment(this.comment).then((response) => {
    ...
    gotoPage(page) {
        commonApi.getPageList(page, this.limit, this.courseId).then((response) => {
        this.data = response.data.data;
      });
    },
  },
